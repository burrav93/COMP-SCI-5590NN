%TRAINING,VALIDATING ON BGP FEATURES OF SAGEM SENSOR AND TESTING ON BGP
%FEATURES OF DIGITAL SENSOR

%TRAINING ON BGP FEATURES OF SAGEM SENSOR
tr_BGP=[Train_All_Data_SageBGP(:,1:916) Train_All_Data_SageBGP(:,1016:1936)]*(10^8);
trl_BGP=[Train_All_Label_SageBGP(:,1:916) Train_All_Label_SageBGP(:,1016:1936)];

%VALIDATING A SET OF DATA FROM TRAIN DATA OF BGP FEATURES OF SAGEM SENSOR
trvali_BGP=[Train_All_Data_SageBGP(:,916:1016) Train_All_Data_SageBGP(:,1936:2016)].*(10^8);
trlvali_BGP=[Train_All_Label_SageBGP(:,916:1016) Train_All_Label_SageBGP(:,1936:2016)];

%TESTING ENTIRELY ON BGP FEATURES DATA OF SAGEM SENSOR
ts_BGP=[Test_All_Data_DigiBGP].*(10^8);
tsl_BGP=[Test_All_Label_DigiBGP];
