% TRAINING,VALIDATING ON LBP FEATURES OF DIGITAL SENSOR AND TESTING ON 
% LBP FEATURES OF SAGEM SENSOR

%TRAINING ON LBP FEATURES OF DIGITAL SENSOR
tr_LBP=[Train_All_Data_DigiLBP(:,1:916 )  Train_All_Data_DigiLBP(:,1016:1904 )];
trl_LBP=[Train_All_Label_DigiLBP(:,1:916) Train_All_Label_DigiLBP(:,1016:1904) ];

%VALIDATING A SET OF DATA FROM TRAIN DATA OF LBP FEATURES OF DIGITAL SENSOR
trvali_LBP=[Train_All_Data_DigiLBP(:,916:1016) Train_All_Data_SageLBP(:,1904:2004)];
trlvali_LBP=[Train_All_Label_DigiLBP(:,916:1016) Train_All_Label_SageLBP(:,1904:2004)];

%TESTING ENTIRELY ON LBP FEATURES DATA OF SAGEM SENSOR
ts_LBP=[Test_All_Data_SageLBP];
tsl_LBP=[Test_All_Label_SageLBP];
