...
%TRAINING ON ENTIRE DATA OF BGP FEATURES OF DIGITAL SENSOR
load('Train_All_Data_DigiBGP.mat');           
tr_BGP=Train_All_Data_DigiBGP*(10^8);
load('Train_All_Label_DigiBGP.mat');           
trl_BGP=Train_All_Label_DigiBGP;

%TESTING ON ENTIRE DATA OF BGP FEATURES OF DIGITAL SENSOR
