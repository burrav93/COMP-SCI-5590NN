...
%TRAINING ON ENTIRE DATA OF LBP FEATURES OF SAGEM SENSOR
load('Train_All_Data_SageLBP.mat');
tr_LBP=Train_All_Data_SageLBP;
load('Train_All_Label_SageLBP.mat');
trl_LBP=Train_All_Label_SageLBP;

%TESTING ON ENTIRE DATA OF LBP FEATURES OF SAGEM SENSOR
load('Test_All_Data_SageLBP.mat');
ts_LBP=Test_All_Data_SageLBP;
load('Test_All_Label_SageLBP.mat');
tsl_LBP=Test_All_Data_SageLBP;
